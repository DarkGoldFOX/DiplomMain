...
res = text[0][-2]
final_image = cv2.putText(img, res, (y2, x1 + 60), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 255), 2)
final_image = cv2.rectangle(img, (y2, x2), (y1, x1), (0, 255, 0), 2)

pl.imshow(cv2.cvtColor(final_image, cv2.COLOR_BGR2RGB))
pl.savefig('final image/final_image.png')
pl.show()